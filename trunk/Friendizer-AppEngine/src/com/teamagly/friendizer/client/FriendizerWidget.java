 ...
 * the License.
 */
package com.teamagly.friendizer.client;
...
import com.teamagly.friendizer.client.MyRequestFactory.HelloWorldRequest;
import com.teamagly.friendizer.client.MyRequestFactory.MessageRequest;
import com.teamagly.friendizer.shared.MessageProxy;

public class FriendizerWidget extends Composite {
  ...
  interface FriendizerUiBinder extends UiBinder<Widget, FriendizerWidget> {
  }

  private static FriendizerUiBinder uiBinder = GWT.create(FriendizerUiBinder.class);
