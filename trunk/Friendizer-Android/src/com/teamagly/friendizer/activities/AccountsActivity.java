...
public class AccountsActivity extends Activity {
    ...
    /**
     * Retrieves the authorization cookie associated with the given token. This method should only be used when running against a
     * production appengine backend (as opposed to a dev mode server).
     */
