...
import com.teamagly.friendizer.adapters.*;
 ...
 * @author Guy
 * 
 *         Note: the child class has to call showLoadingIcon(false) after it's
 *         done reloading the data in order to stop the loading indicator
 */
public abstract class AbstractFriendsListActivity extends ListActivity implements OnItemClickListener {
	...
	/**
	 * @param show
	 *            whether to show or hide the loading icon (in the parent
	 *            activity)
	 */
